const modalidades = require("../data/modalidad.json");

const filtrarTipoCodigo = req => {
    let obj;
    obj = modalidades.filter(mod => mod.nAcdTipoCodigo.toString() === req.nAcdTipoCodigo);
    return response(obj, true);
};

module.exports = {
    getModalidades: response(modalidades, true),
    getModalidadByTipo: filtrarTipoCodigo,
