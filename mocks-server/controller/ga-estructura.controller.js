const estructura = require("../data/ga-estructura.json");

module.exports = {
    getEstructuraList: response(estructura, true),
    getEstructura: responseByID(...estructura.filter(data => data.nGAEstAmbientes === 4), true),
