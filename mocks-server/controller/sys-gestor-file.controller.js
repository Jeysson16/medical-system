const lstSysGestorFile = require("../data/sys-gestor-file.json");

module.exports = {
    getLstSysGestorFile: response(lstSysGestorFile, true),
    getSysGestorFile: responseID(lstSysGestorFile[0], true),
