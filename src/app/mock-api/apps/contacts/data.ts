...
export const contacts = [
    ...
    {
        id: "01a2b3c4-5d6e-7f8g-9h10-ijklmnopqrst",
        avatar: "assets/images/avatars/male-01.jpg",
        background: "assets/images/cards/15-640x480.jpg",
        name: "Flores Moya Mathias",
        emails: [
            {
                email: "mathias_flores@hotmail.com",
                label: "Personal"
            }
        ],
        phoneNumbers: [
            {
                country: "pe",
                phoneNumber: "944 123 456",
                label: "Celular"
            }
        ],
        title: "Estudiante de Ingeniería de Sistemas",
        birthday: "1998-07-22T12:00:00.000Z",
        address: "Trujillo, Perú",
        notes: "<p>Amante de la tecnología y los videojuegos. Apasionado por la inteligencia artificial y los deportes electrónicos.</p>",
        tags: ["3f1a9f64-7c3e-432a-b1a5-e5df2c839b47"]
    },
    {
        id: "11b2c3d4-5e6f-7g8h-9i10-jklmnopqrstuv",
        avatar: "assets/images/avatars/male-02.jpg",
        background: "assets/images/cards/16-640x480.jpg",
        name: "Sánchez Rodríguez Jeysson",
        emails: [
            {
                email: "jeysson_sanchez@gmail.com",
                label: "Personal"
            }
        ],
        phoneNumbers: [
            {
                country: "pe",
                phoneNumber: "933 654 789",
                label: "Celular"
            }
        ],
        title: "Estudiante de Derecho",
        birthday: "2000-03-15T12:00:00.000Z",
        address: "Lima, Perú",
        notes: "<p>Interesado en derecho penal y derechos humanos. Voluntario en organizaciones sin fines de lucro.</p>",
        tags: ["4d3e9f75-8c5b-432a-c1b5-f6df3c839b48"]
    },
    {
        id: "21c3d4e5-6f7g-8h9i-10jk-lmnopqrstuvwxy",
        avatar: "assets/images/avatars/female-01.jpg",
        background: "assets/images/cards/17-640x480.jpg",
        name: "Reyna Pastor Ximena",
        emails: [
            {
                email: "ximena_pastor@outlook.com",
                label: "Personal"
            }
        ],
        phoneNumbers: [
            {
                country: "pe",
                phoneNumber: "947 987 321",
                label: "Celular"
            }
        ],
        title: "Estudiante de Medicina",
        birthday: "1999-09-30T12:00:00.000Z",
        address: "Arequipa, Perú",
        notes: "<p>Comprometida con la salud pública y la investigación en enfermedades tropicales.</p>",
        tags: ["5f4a0e85-9d6c-543b-d2c6-g7df4c839b49"]
    },
    {
        id: "31d4e5f6-7g8h-9i10-jklm-nopqrstuvwxyz",
        avatar: "assets/images/avatars/male-03.jpg",
        background: "assets/images/cards/18-640x480.jpg",
        name: "Ruiz Rodríguez Néstor",
        emails: [
            {
                email: "nestor_ruiz@yahoo.com",
                label: "Personal"
            }
        ],
        phoneNumbers: [
            {
                country: "pe",
                phoneNumber: "946 852 147",
                label: "Celular"
            }
        ],
        title: "Estudiante de Economía",
        birthday: "2001-01-25T12:00:00.000Z",
        address: "Cusco, Perú",
        notes: "<p>Enfocado en macroeconomía y desarrollo sostenible. Apasionado por los viajes y la cultura andina.</p>",
        tags: ["6f5b1f95-ae7d-654c-e3d7-h8df5c839b50"]
    },
    {
        id: "41e5f6g7-8h9i-10jk-lmno-pqrstuvwxyzab",
        avatar: "assets/images/avatars/male-04.jpg",
        background: "assets/images/cards/19-640x480.jpg",
        name: "Montes Rojas Christian",
        emails: [
            {
                email: "christian_montes@upe.edu.pe",
                label: "Institucional"
            }
        ],
        phoneNumbers: [
            {
                country: "pe",
                phoneNumber: "932 456 789",
                label: "Celular"
            }
        ],
        title: "Estudiante de Psicología",
        birthday: "1997-11-05T12:00:00.000Z",
        address: "Chiclayo, Perú",
        notes: "<p>Interesado en psicología educativa y terapias cognitivo-conductuales.</p>",
        tags: ["7g6c2f05-bf8e-765d-f4e8-i9df6c839b51"]
    },
    {
        ...
        phoneNumbers: [
            {
                country: "pe",
                phoneNumber: "937 042 560",
                label: "Celular"
            }
        ],
        title: "Estudiante Universitaria",
        birthday: "2002-05-17T12:00:00.000Z",
