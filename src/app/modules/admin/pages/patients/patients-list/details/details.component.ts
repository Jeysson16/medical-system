...
export class PatientsDetailsComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _contactsListComponent: PatientsViewListComponent,
        private _contactsService: PatientsService,
    ...
    ngOnInit(): void {
        ...
        // Get the contacts
        this._contactsService.contacts$.pipe(takeUntil(this._unsubscribeAll)).subscribe((contacts: Patient[]) => {
        ...
        // Get the contact
        this._contactsService.contact$.pipe(takeUntil(this._unsubscribeAll)).subscribe((contact: Patient) => {
